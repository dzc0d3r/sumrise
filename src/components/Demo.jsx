...
const Demo = () => {
    ...
    return (
        <section className="mt-16 w-full max-w-xl">
            ...
            <div className="flex flex-col w-full gap-2">
                ...
                <div className='flex flex-col gap-1 max-h-60 overflow-y-auto'>
                    {allArticles.map((item, index) => (
                        ...
                        >
                            <div className='copy_btn' onClick={() => handleClipBoard(item.url)}>
                                <img
            ...
            <div className='my-10 max-w-flux flex justify-center items-center'>

                {isFetching ? (
                    <img src={loader} alt="loader" className='w-20 h-20 object-contain' />
                ) : error ? (
                    <p className='font-inter font-blod text-black text-center'>
                    ...
                    article.summary && (
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='summary_box'>
                                <p className='font-inter font-medi
